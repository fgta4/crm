...
class DataSave extends WebAPI {
	...
	public function execute($data, $options) {
		$tablename = 'trn_crmmsgcsitem';
		$primarykey = 'crmmsgcsitem_id';
		...
		try {
			...
			// if ($obj->site_id=='--NULL--') { unset($obj->site_id); }
			...
			$sql = \FGTA4\utils\SqlUtility::Select($tablename , [
				$primarykey,  'crmmsgcsitem_id', 'crmmsgcsitem_message', 'crmmsgclass_id', 'brand_id', 'site_id', 'crmmsgcs_id', '_createby', '_createdate', '_modifyby', '_modifydate', '_createby', '_createdate', '_modifyby', '_modifydate'
			], $where->sql);
			...
			$result->dataresponse = (object) array_merge($dataresponse, [
				...
				'crmmsgclass_name' => \FGTA4\utils\SqlUtility::Lookup($data->crmmsgclass_id, $this->db, 'mst_crmmsgclass', 'crmmsgclass_id', 'crmmsgclass_name'),
