...
class DataSave extends WebAPI {
	...
	public function execute($data, $options) {
		...
		try {
			...
			$obj->partneruser_email1 = strtoupper($obj->partneruser_email1);
			$obj->partneruser_password = strtoupper($obj->partneruser_password);
			...
			$sql = \FGTA4\utils\SqlUtility::Select($tablename , [
				$primarykey,  'partneruser_id', 'partneruser_email1', 'partneruser_password', 'partneruser_isdisabled', 'partner_id', '_createby', '_createdate', '_modifyby', '_modifydate', '_createby', '_createdate', '_modifyby', '_modifydate'
			], $where->sql);
