...
import * as hnd from  './voureq-edit-hnd.mjs'
...
const obj = {
	txt_voureq_id: $('#pnl_edit-txt_voureq_id'),
	txt_voureq_room: $('#pnl_edit-txt_voureq_room'),
	txt_voureq_phone: $('#pnl_edit-txt_voureq_phone'),
	txt_voureq_message: $('#pnl_edit-txt_voureq_message'),
	chk_voureq_isvougenerate: $('#pnl_edit-chk_voureq_isvougenerate'),
	txt_voureq_result: $('#pnl_edit-txt_voureq_result'),
	txt_vou_id: $('#pnl_edit-txt_vou_id'),
	txt_site_id: $('#pnl_edit-txt_site_id'),
	txt_voureq_info: $('#pnl_edit-txt_voureq_info'),
	chk_voureq_isresend: $('#pnl_edit-chk_voureq_isresend')
}
...
export function createnew() {
	...
	form.createnew(async (data, options)=>{
		...
		data.voureq_isvougenerate = '0'
		data.voureq_isresend = '0'
