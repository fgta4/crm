...
if (is_file(__DIR__ .'/voureq.php-handler.php')) {
	require_once __DIR__ .'/voureq.php-handler.php';
}

/**
 * crm/voucher/voureq/voureq.php
 *
 * ===================================================================
 * Entry point Program Module voureq
 * ===================================================================
 ...
 * awal dibuat tanggal 06/10/2023
 * terakhir di generate tanggal 11/10/2023
 */
$MODULE = new class extends WebModule {
	...
	public function LoadPage() {
		...
		$handlerclassname = "\\FGTA4\\module\\voureq_pageHandler";
		if (class_exists($handlerclassname)) {
			$hnd = new voureq_pageHandler();
			$hnd->caller = &$this;
			$hnd->auth = $this->auth;
