...
if (is_file(__DIR__ .'/voubatch.php-handler.php')) {
	require_once __DIR__ .'/voubatch.php-handler.php';
}

/**
 * crm/voucher/voubatch/voubatch.php
 *
 * ===================================================================
 * Entry point Program Module voubatch
 * ===================================================================
 ...
 * terakhir di generate tanggal 25/10/2023
 */
$MODULE = new class extends WebModule {
	...
	public function LoadPage() {
		...
		$handlerclassname = "\\FGTA4\\module\\voubatch_pageHandler";
		if (class_exists($handlerclassname)) {
			$hnd = new voubatch_pageHandler();
			$hnd->caller = &$this;
			$hnd->auth = $this->auth;
