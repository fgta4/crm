...
import * as hnd from  './voumodel-edit-hnd.mjs'
...
const obj = {
	txt_voumodel_id: $('#pnl_edit-txt_voumodel_id'),
	txt_voumodel_name: $('#pnl_edit-txt_voumodel_name'),
	txt_voumodel_descr: $('#pnl_edit-txt_voumodel_descr')
}
...
export async function init(opt) {
	...
	form = new global.fgta4form(pnl_form, {
		primary: obj.txt_voumodel_id,
		autoid: false,
		logview: 'mst_voumodel',
