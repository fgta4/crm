...
if (is_file(__DIR__ .'/voumodel.php-handler.php')) {
	require_once __DIR__ .'/voumodel.php-handler.php';
}

/**
 * crm/voucher/voumodel/voumodel.php
 *
 * ===================================================================
 * Entry point Program Module voumodel
 * ===================================================================
...
$MODULE = new class extends WebModule {
	...
	public function LoadPage() {
		...
		$handlerclassname = "\\FGTA4\\module\\voumodel_pageHandler";
		if (class_exists($handlerclassname)) {
			$hnd = new voumodel_pageHandler();
			$hnd->caller = &$this;
			$hnd->auth = $this->auth;
