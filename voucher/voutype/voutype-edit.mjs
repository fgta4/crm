...
import * as hnd from  './voutype-edit-hnd.mjs'
...
const obj = {
	txt_voutype_id: $('#pnl_edit-txt_voutype_id'),
	txt_voutype_name: $('#pnl_edit-txt_voutype_name'),
	txt_voutype_descr: $('#pnl_edit-txt_voutype_descr'),
	txt_voutype_randalocstart: $('#pnl_edit-txt_voutype_randalocstart'),
	txt_voutype_randalocend: $('#pnl_edit-txt_voutype_randalocend')
}
...
export function createnew() {
	form.createnew(async (data, options)=>{
		...
		data.voutype_randalocstart = 0
		data.voutype_randalocend = 0
