...
if (is_file(__DIR__ .'/voutype.php-handler.php')) {
	require_once __DIR__ .'/voutype.php-handler.php';
}

/**
 * crm/voucher/voutype/voutype.php
 *
 * ===================================================================
 * Entry point Program Module voutype
 * ===================================================================
...
$MODULE = new class extends WebModule {
	...
	public function LoadPage() {
		...
		$handlerclassname = "\\FGTA4\\module\\voutype_pageHandler";
		if (class_exists($handlerclassname)) {
			$hnd = new voutype_pageHandler();
			$hnd->caller = &$this;
			$hnd->auth = $this->auth;
