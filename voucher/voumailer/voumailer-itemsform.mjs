...
import * as hnd from  './voumailer-itemsform-hnd.mjs'
...
const obj = {
	txt_voumaileritem_id: $('#pnl_edititemsform-txt_voumaileritem_id'),
	txt_voumailer_subject: $('#pnl_edititemsform-txt_voumailer_subject'),
	txt_voumailer_body: $('#pnl_edititemsform-txt_voumailer_body'),
	cbo_voubatch_id: $('#pnl_edititemsform-cbo_voubatch_id'),
	txt_voumaileritem_qty: $('#pnl_edititemsform-txt_voumaileritem_qty'),
	txt_voumailer_id: $('#pnl_edititemsform-txt_voumailer_id')
}
...
export async function init(opt) {
	...
	form = new global.fgta4form(pnl_form, {
		primary: obj.txt_voumaileritem_id,
		autoid: true,
		logview: 'mst_voumaileritem',
		btn_edit: btn_edit,
		btn_save: btn_save,
	...
	obj.cbo_voubatch_id.name = 'pnl_edititemsform-cbo_voubatch_id'		
	new fgta4slideselect(obj.cbo_voubatch_id, {
		title: 'Pilih voubatch_id',
		returnpage: this_page_id,
		api: $ui.apis.load_voubatch_id,
		fieldValue: 'voubatch_id',
		fieldDisplay: 'voubatch_descr',
		fields: [
			{mapping: 'voubatch_id', text: 'voubatch_id'},
			{mapping: 'voubatch_descr', text: 'voubatch_descr'}
		],
...
*/
		...
		form
			.fill(record)
			.setValue(obj.cbo_voubatch_id, record.voubatch_id, record.voubatch_descr)
			.setViewMode()
			.rowid = rowid
...
export function createnew(hdata) {
	...
	form.createnew(async (data, options)=>{
		...
		data.voumaileritem_qty = 0

		data.voubatch_id = '0'
		data.voubatch_descr = '-- PILIH --'
...
function form_idsetup(options) {
	var objid = obj.txt_voumaileritem_id
