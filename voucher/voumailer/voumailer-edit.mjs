...
import * as hnd from  './voumailer-edit-hnd.mjs'
...
const obj = {
	txt_voumailer_id: $('#pnl_edit-txt_voumailer_id'),
	dt_voumailer_dt: $('#pnl_edit-dt_voumailer_dt'),
	txt_voumailer_descr: $('#pnl_edit-txt_voumailer_descr'),
	txt_voumailer_subject: $('#pnl_edit-txt_voumailer_subject'),
	txt_voumailer_body: $('#pnl_edit-txt_voumailer_body'),
	chk_voumailer_isprepared: $('#pnl_edit-chk_voumailer_isprepared'),
	chk_voumailer_ismailed: $('#pnl_edit-chk_voumailer_ismailed'),
	txt_voumailer_version: $('#pnl_edit-txt_voumailer_version'),
	chk_voumailer_iscommit: $('#pnl_edit-chk_voumailer_iscommit'),
	txt_voumailer_commitby: $('#pnl_edit-txt_voumailer_commitby'),
	txt_voumailer_commitdate: $('#pnl_edit-txt_voumailer_commitdate')
}
...
export async function init(opt) {
	...
	form = new global.fgta4form(pnl_form, {
		primary: obj.txt_voumailer_id,
		autoid: true,
		logview: 'mst_voumailer',
...
export function createnew() {
	form.createnew(async (data, options)=>{
		...
		data.voumailer_dt = global.now()
		data.voumailer_isprepared = '0'
		data.voumailer_ismailed = '0'
		data.voumailer_version = 0
		data.voumailer_iscommit = '0'
		...
		$ui.getPages().ITEMS['pnl_editemailgrid'].handler.createnew(data, options)
		$ui.getPages().ITEMS['pnl_editquegrid'].handler.createnew(data, options)
...
function updaterecordstatus(record) {
	...
	rec_commitby.html(record.voumailer_commitby);
	rec_commitdate.html(record.voumailer_commitdate);
...
function updatebuttonstate(record) {
	...
	if (record.voumailer_iscommit=="1") {
...
function updategridstate(record) {
	...
	var col_commit = 'voumailer_iscommit';
	updategriddata[col_commit] = record.voumailer_iscommit;	
...
function form_idsetup(options) {
	var objid = obj.txt_voumailer_id
...
async function btn_action_click(args) {
	...
	var docname = 'Voucher Mailer'
	var txt_version = obj.txt_voumailer_version;
	var chk_iscommit = obj.chk_voumailer_iscommit;
