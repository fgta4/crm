...
/**
 * crm/engage/mediaposttype/apis/list.php
 *
 * ========
 * DataList
 * ========
 * Menampilkan data-data pada tabel header mediaposttype (mst_mediaposttype)
...
$API = new class extends mediaposttypeBase {
	...
	public function execute($options) {
		...
		try {
			...
			$criteriaValues = [
				"search" => " A.mediaposttype_id LIKE CONCAT('%', :search, '%') OR A.mediaposttype_name LIKE CONCAT('%', :search, '%') "
			];
