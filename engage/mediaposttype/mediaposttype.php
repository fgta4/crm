...
if (is_file(__DIR__ .'/mediaposttype.php-handler.php')) {
	require_once __DIR__ .'/mediaposttype.php-handler.php';
}

/**
 * crm/engage/mediaposttype/mediaposttype.php
 *
 * ===================================================================
 * Entry point Program Module mediaposttype
 * ===================================================================
 ...
 * awal dibuat tanggal 23/11/2023
...
$MODULE = new class extends WebModule {
	...
	public function LoadPage() {
		...
		$handlerclassname = "\\FGTA4\\module\\mediaposttype_pageHandler";
		if (class_exists($handlerclassname)) {
			$hnd = new mediaposttype_pageHandler();
			$hnd->caller = &$this;
			$hnd->auth = $this->auth;
