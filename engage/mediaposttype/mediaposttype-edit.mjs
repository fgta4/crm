...
import * as hnd from  './mediaposttype-edit-hnd.mjs'
...
const obj = {
	txt_mediaposttype_id: $('#pnl_edit-txt_mediaposttype_id'),
	txt_mediaposttype_name: $('#pnl_edit-txt_mediaposttype_name'),
	chk_mediaposttype_iskol: $('#pnl_edit-chk_mediaposttype_iskol')
}
...
export async function init(opt) {
	...
	form = new global.fgta4form(pnl_form, {
		primary: obj.txt_mediaposttype_id,
		autoid: false,
		logview: 'mst_mediaposttype',
...
function form_idsetup(options) {
	var objid = obj.txt_mediaposttype_id
