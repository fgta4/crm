...
import * as hnd from  './koltype-edit-hnd.mjs'
...
const obj = {
	txt_koltype_id: $('#pnl_edit-txt_koltype_id'),
	txt_koltype_name: $('#pnl_edit-txt_koltype_name')
}
