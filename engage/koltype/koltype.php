...
if (is_file(__DIR__ .'/koltype.php-handler.php')) {
	require_once __DIR__ .'/koltype.php-handler.php';
}

/**
 * crm/engage/koltype/koltype.php
 *
 * ===================================================================
 * Entry point Program Module koltype
 * ===================================================================
 ...
 * awal dibuat tanggal 24/11/2023
 * terakhir di generate tanggal 24/11/2023
 */
$MODULE = new class extends WebModule {
	...
	public function LoadPage() {
		...
		$handlerclassname = "\\FGTA4\\module\\koltype_pageHandler";
		if (class_exists($handlerclassname)) {
			$hnd = new koltype_pageHandler();
			$hnd->caller = &$this;
			$hnd->auth = $this->auth;
