...
/**
 * crm/engage/koltype/apis/list.php
 *
 * ========
 * DataList
 * ========
 * Menampilkan data-data pada tabel header koltype (mst_koltype)
...
$API = new class extends koltypeBase {
	...
	public function execute($options) {
		...
		try {
			...
			$criteriaValues = [
				"search" => " A.koltype_id LIKE CONCAT('%', :search, '%') OR A.koltype_name LIKE CONCAT('%', :search, '%') "
			];
