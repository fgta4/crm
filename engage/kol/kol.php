...
if (is_file(__DIR__ .'/kol.php-handler.php')) {
	require_once __DIR__ .'/kol.php-handler.php';
}

/**
 * crm/engage/kol/kol.php
 *
 * ===================================================================
 * Entry point Program Module kol
 * ===================================================================
...
$MODULE = new class extends WebModule {
	...
	public function LoadPage() {
		...
		$handlerclassname = "\\FGTA4\\module\\kol_pageHandler";
		if (class_exists($handlerclassname)) {
			$hnd = new kol_pageHandler();
			$hnd->caller = &$this;
			$hnd->auth = $this->auth;
