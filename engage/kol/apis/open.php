	...
	public function execute($options) {
		...
		try {
			...
			$result->record = array_merge($record, [
				'kol_birthdate' => date("d/m/Y", strtotime($record['kol_birthdate'])),
			...
			try { $result->record['kol_picture_doc'] = $this->cdb->getAttachment($file_id, 'filedata'); } catch (\Exception $ex) {}
