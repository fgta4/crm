...
/**
 * crm/engage/kol/apis/xapi.base.php
 *
 * kolBase
 * Kelas dasar untuk keperluan-keperluan api
 * kelas ini harus di-inherit untuk semua api pada modul kol
 *
 ...
 * tanggal 24/11/2023
 */
class kolBase extends WebAPI {

	protected $main_tablename = "mst_kol";
	protected $main_primarykey = "kol_id";
	protected $main_field_version = "kol_version";	
	...
	function __construct() {
		...
		// $logfilepath = __LOCALDB_DIR . "/output//*kol*/.txt";
		// debug::disable();
