...
/**
 * crm/engage/broadcastmsg/apis/target-save.php
 *
 * ==========
 * Detil-Save
 * ==========
...
$API = new class extends broadcastmsgBase {
	...
	public function execute($data, $options, $files) {
		...
		try {
			...
			if ($obj->broadcastmsgcust_reasonrejectoffer=='') { $obj->broadcastmsgcust_reasonrejectoffer = '--NULL--'; }



			unset($obj->broadcastmsgcust_isfail);
			...
			try {
				...
				$sql = \FGTA4\utils\SqlUtility::Select($tablename , [
					$primarykey
					, 'broadcastmsgcust_id', 'broadcastmsgcust_name', 'broadcastmsgcust_data', 'broadcastmsgcust_isnew', 'broadcastmsgcust_isrecvoffer', 'broadcastmsgcust_reasonrejectoffer', 'broadcastmsgcust_var1', 'broadcastmsgcust_var2', 'broadcastmsgcust_var3', 'broadcastmsgcust_var4', 'broadcastmsgcust_var5', 'broadcastmsgcust_isfail', 'broadcastmsgcust_failreason', 'broadcastmsg_id', '_createby', '_createdate', '_modifyby', '_modifydate', '_createby', '_createdate', '_modifyby', '_modifydate'
				], $where->sql);
