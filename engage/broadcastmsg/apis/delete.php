...
/**
 * crm/engage/broadcastmsg/apis/delete.php
 *
 * ======
 * Delete
 * ======
 * Menghapus satu baris data/record berdasarkan PrimaryKey
 * pada tabel header broadcastmsg (trn_broadcastmsg)
 *
	...
	public function execute($data, $options) {
		...
		try {
			...
			try {
				...
				$tabletodelete = ['trn_broadcastmsgresult', 'trn_broadcastmsgcust', 'trn_broadcastmsgresult', 'trn_broadcastmsgfiles'];
