...
import * as hnd from  './broadcastmsg-targetform-hnd.mjs'
...
const obj = {
	txt_broadcastmsgcust_id: $('#pnl_edittargetform-txt_broadcastmsgcust_id'),
	txt_broadcastmsgcust_name: $('#pnl_edittargetform-txt_broadcastmsgcust_name'),
	txt_broadcastmsgcust_data: $('#pnl_edittargetform-txt_broadcastmsgcust_data'),
	chk_broadcastmsgcust_isnew: $('#pnl_edittargetform-chk_broadcastmsgcust_isnew'),
	chk_broadcastmsgcust_isrecvoffer: $('#pnl_edittargetform-chk_broadcastmsgcust_isrecvoffer'),
	txt_broadcastmsgcust_reasonrejectoffer: $('#pnl_edittargetform-txt_broadcastmsgcust_reasonrejectoffer'),
	txt_broadcastmsgcust_var1: $('#pnl_edittargetform-txt_broadcastmsgcust_var1'),
	txt_broadcastmsgcust_var2: $('#pnl_edittargetform-txt_broadcastmsgcust_var2'),
	txt_broadcastmsgcust_var3: $('#pnl_edittargetform-txt_broadcastmsgcust_var3'),
	txt_broadcastmsgcust_var4: $('#pnl_edittargetform-txt_broadcastmsgcust_var4'),
	txt_broadcastmsgcust_var5: $('#pnl_edittargetform-txt_broadcastmsgcust_var5'),
	chk_broadcastmsgcust_isfail: $('#pnl_edittargetform-chk_broadcastmsgcust_isfail'),
	txt_broadcastmsgcust_failreason: $('#pnl_edittargetform-txt_broadcastmsgcust_failreason'),
	txt_broadcastmsg_id: $('#pnl_edittargetform-txt_broadcastmsg_id')
}
...
export async function init(opt) {
	...
	form = new global.fgta4form(pnl_form, {
		primary: obj.txt_broadcastmsgcust_id,
		autoid: true,
		logview: 'trn_broadcastmsgcust',
		btn_edit: btn_edit,
		btn_save: btn_save,
...
function form_idsetup(options) {
	var objid = obj.txt_broadcastmsgcust_id
