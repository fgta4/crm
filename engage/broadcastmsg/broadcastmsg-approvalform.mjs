...
const obj = {
	txt_broadcastmsgappr_id: $('#pnl_editapprovalform-txt_broadcastmsgappr_id'),
	chk_broadcastmsgappr_isapproved: $('#pnl_editapprovalform-chk_broadcastmsgappr_isapproved'),
	txt_broadcastmsgappr_by: $('#pnl_editapprovalform-txt_broadcastmsgappr_by'),
	txt_broadcastmsgappr_date: $('#pnl_editapprovalform-txt_broadcastmsgappr_date'),
	txt_broadcastmsg_version: $('#pnl_editapprovalform-txt_broadcastmsg_version'),
	chk_broadcastmsgappr_isdeclined: $('#pnl_editapprovalform-chk_broadcastmsgappr_isdeclined'),
	txt_broadcastmsgappr_declinedby: $('#pnl_editapprovalform-txt_broadcastmsgappr_declinedby'),
	txt_broadcastmsgappr_declineddate: $('#pnl_editapprovalform-txt_broadcastmsgappr_declineddate'),
	txt_broadcastmsgappr_notes: $('#pnl_editapprovalform-txt_broadcastmsgappr_notes'),
	txt_broadcastmsg_id: $('#pnl_editapprovalform-txt_broadcastmsg_id'),
...
export async function init(opt) {
	...
	form = new global.fgta4form(pnl_form, {
		primary: obj.txt_broadcastmsgappr_id,
		autoid: true,
		logview: 'trn_broadcastmsgappr',
		btn_edit: btn_edit,
		btn_save: btn_save,
...
export function open(data, rowid, hdata) {
	...
	txt_title.html(hdata.broadcastmsg_id)
	header_data = hdata
...
function form_idsetup(options) {
	var objid = obj.txt_broadcastmsgappr_id
