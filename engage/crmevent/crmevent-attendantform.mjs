...
import * as hnd from  './crmevent-attendantform-hnd.mjs'

const reload_header_modified = true;

const txt_caption = $('#pnl_editattendantform-caption')
...
const obj = {
	...
	txt_invitation_id: $('#pnl_editattendantform-txt_invitation_id'),
	txt_crmeventattendant_phone: $('#pnl_editattendantform-txt_crmeventattendant_phone'),
	...
	dt_crmeventattendant_date: $('#pnl_editattendantform-dt_crmeventattendant_date'),
	txt_crmeventattendant_time: $('#pnl_editattendantform-txt_crmeventattendant_time'),
...
export function createnew(hdata) {
	...
	form.createnew(async (data, options)=>{
		...
		data.crmeventattendant_date = global.now()
