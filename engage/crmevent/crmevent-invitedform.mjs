...
import * as hnd from  './crmevent-invitedform-hnd.mjs'

const reload_header_modified = true;

const txt_caption = $('#pnl_editinvitedform-caption')
...
const obj = {
	...
	txt_crmeventinvited_phone: $('#pnl_editinvitedform-txt_crmeventinvited_phone'),
	txt_crmeventinvited_email: $('#pnl_editinvitedform-txt_crmeventinvited_email'),
	txt_invitation_id: $('#pnl_editinvitedform-txt_invitation_id'),
...
/*
		if (record.user_id==null) { record.user_id='--NULL--'; record.user_fullname='NONE'; }
...
*/
		...
		form
			.fill(record)
			.setValue(obj.cbo_user_id, record.user_id, record.user_fullname)
			.setViewMode()
			.rowid = rowid
...
async function form_datasaving(data, options) {
	...
	// options.skipmappingresponse = ['user_id', ];
...
async function form_datasaved(result, options) {
	...
	/*
	form.setValue(obj.cbo_user_id, result.dataresponse.user_fullname!=='--NULL--' ? result.dataresponse.user_id : '--NULL--', result.dataresponse.user_fullname!=='--NULL--'?result.dataresponse.user_fullname:'NONE')
