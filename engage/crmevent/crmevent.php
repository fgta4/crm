...
if (is_file(__DIR__ .'/crmevent.php-handler.php')) {
	require_once __DIR__ .'/crmevent.php-handler.php';
}

/**
 * crm/engage/crmevent/crmevent.php
 *
 * ===================================================================
 * Entry point Program Module crmevent
 * ===================================================================
 ...
 * terakhir di generate tanggal 26/10/2023
 */
$MODULE = new class extends WebModule {
	...
	public function LoadPage() {
		...
		$handlerclassname = "\\FGTA4\\module\\crmevent_pageHandler";
		if (class_exists($handlerclassname)) {
			$hnd = new crmevent_pageHandler();
			$hnd->caller = &$this;
			$hnd->auth = $this->auth;
