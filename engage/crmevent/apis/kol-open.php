...
/**
 * crm/engage/crmevent/apis/kol-open.php
 *
 * ==========
 * Detil-Open
 * ==========
...
$API = new class extends crmeventBase {
	...
	public function execute($options) {
		...
		if (class_exists($handlerclassname)) {
			$hnd = new crmevent_kolHandler($options);
			$hnd->caller = &$this;
			$hnd->db = $this->db;
			$hnd->auth = $this->auth;
...
/*{__LOOKUPUSERMERGE__}*/
			...
			try { $result->record['crmeventkol_file_doc'] = $this->cdb->getAttachment($file_id, 'filedata'); } catch (\Exception $ex) {}
