...
/**
 * crm/engage/crmevent/apis/xapi.base.php
 *
 * crmeventBase
 * Kelas dasar untuk keperluan-keperluan api
 * kelas ini harus di-inherit untuk semua api pada modul crmevent
 *
 ...
 * tanggal 24/11/2023
 */
class crmeventBase extends WebAPI {

	protected $main_tablename = "trn_crmevent";
	protected $main_primarykey = "crmevent_id";
	protected $main_field_version = "crmevent_version";	
	...
	function __construct() {
		...
		// $logfilepath = __LOCALDB_DIR . "/output//*crmevent*/.txt";
		// debug::disable();
