...
/**
 * crm/engage/crmevent/apis/invited-list.php
 *
 * ==============
 * Detil-DataList
 * ==============
 * Menampilkan data-data pada tabel invited crmevent (trn_crmeventinvited)
		...
		try {
			...
			foreach ($rows as $row) {
				...
				*/
				...
				$this->addFields('user_fullname', 'user_id', $record, 'fgt_user', 'user_fullname', 'user_id');
