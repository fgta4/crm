...
import * as hnd from  './media-edit-hnd.mjs'
...
const obj = {
	txt_media_id: $('#pnl_edit-txt_media_id'),
	txt_media_name: $('#pnl_edit-txt_media_name'),
	chk_media_isdisabled: $('#pnl_edit-chk_media_isdisabled'),
	txt_media_city: $('#pnl_edit-txt_media_city'),
	txt_media_instagram: $('#pnl_edit-txt_media_instagram'),
	txt_media_facebook: $('#pnl_edit-txt_media_facebook'),
	txt_media_twitter: $('#pnl_edit-txt_media_twitter'),
	txt_media_tiktok: $('#pnl_edit-txt_media_tiktok'),
	txt_media_youtube: $('#pnl_edit-txt_media_youtube'),
	txt_media_blog: $('#pnl_edit-txt_media_blog'),
	txt_media_website: $('#pnl_edit-txt_media_website'),
