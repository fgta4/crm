...
if (is_file(__DIR__ .'/media.php-handler.php')) {
	require_once __DIR__ .'/media.php-handler.php';
}

/**
 * crm/engage/media/media.php
 *
 * ===================================================================
 * Entry point Program Module media
 * ===================================================================
...
$MODULE = new class extends WebModule {
	...
	public function LoadPage() {
		...
		$handlerclassname = "\\FGTA4\\module\\media_pageHandler";
		if (class_exists($handlerclassname)) {
			$hnd = new media_pageHandler();
			$hnd->caller = &$this;
			$hnd->auth = $this->auth;
