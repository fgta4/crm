...
/**
 * crm/engage/media/apis/list.php
 *
 * ========
 * DataList
 * ========
 * Menampilkan data-data pada tabel header media (mst_media)
...
$API = new class extends mediaBase {
	...
	public function execute($options) {
		...
		try {
			...
			$criteriaValues = [
				"search" => " A.media_id LIKE CONCAT('%', :search, '%') OR A.media_name LIKE CONCAT('%', :search, '%') "
			];
