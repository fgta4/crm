...
/**
 * crm/master/custwa/apis/list.php
 *
 * ========
 * DataList
 * ========
 * Menampilkan data-data pada tabel header custwa (mst_custwa)
...
$API = new class extends custwaBase {
	...
	public function execute($options) {
		...
		try {
			...
			$criteriaValues = [
				"search" => " A.custwa_id LIKE CONCAT('%', :search, '%') OR A.custwa_name LIKE CONCAT('%', :search, '%') "
			];
