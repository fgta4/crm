...
import * as hnd from  './custwa-edit-hnd.mjs'
...
const obj = {
	txt_custwa_id: $('#pnl_edit-txt_custwa_id'),
	txt_custwa_name: $('#pnl_edit-txt_custwa_name'),
	txt_custwa_gender: $('#pnl_edit-txt_custwa_gender')
}
...
export function createnew() {
	...
	form.createnew(async (data, options)=>{
		...
		$ui.getPages().ITEMS['pnl_editlinkgrid'].handler.createnew(data, options)
