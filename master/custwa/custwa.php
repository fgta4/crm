...
if (is_file(__DIR__ .'/custwa.php-handler.php')) {
	require_once __DIR__ .'/custwa.php-handler.php';
}

/**
 * crm/master/custwa/custwa.php
 *
 * ===================================================================
 * Entry point Program Module custwa
 * ===================================================================
 ...
 * awal dibuat tanggal 30/07/2024
 * terakhir di generate tanggal 08/08/2024
 */
$MODULE = new class extends WebModule {
	...
	public function LoadPage() {
		...
		$handlerclassname = "\\FGTA4\\module\\custwa_pageHandler";
		if (class_exists($handlerclassname)) {
			$hnd = new custwa_pageHandler();
			$hnd->caller = &$this;
			$hnd->auth = $this->auth;
