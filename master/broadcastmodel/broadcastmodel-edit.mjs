...
import * as hnd from  './broadcastmodel-edit-hnd.mjs'
...
const obj = {
	txt_broadcastmodel_id: $('#pnl_edit-txt_broadcastmodel_id'),
	txt_broadcastmodel_name: $('#pnl_edit-txt_broadcastmodel_name')
}
...
export async function init(opt) {
	...
	form = new global.fgta4form(pnl_form, {
		primary: obj.txt_broadcastmodel_id,
		autoid: false,
		logview: 'mst_broadcastmodel',
...
function form_idsetup(options) {
	var objid = obj.txt_broadcastmodel_id
