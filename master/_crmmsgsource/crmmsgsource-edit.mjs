...
const obj = {
	txt_crmmsgsource_id: $('#pnl_edit-txt_crmmsgsource_id'),
	txt_crmmsgsource_name: $('#pnl_edit-txt_crmmsgsource_name')
}
...
export async function init(opt) {
	...
	form = new global.fgta4form(pnl_form, {
		primary: obj.txt_crmmsgsource_id,
		autoid: false,
		logview: 'mst_crmmsgsource',
...
function form_idsetup(options) {
	var objid = obj.txt_crmmsgsource_id
