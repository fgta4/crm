...
/**
 * crm/master/broadcastquota/apis/save.php
 *
 * ====
 * Save
 * ====
...
$API = new class extends broadcastquotaBase {
	...
	public function execute($data, $options) {
		...
		try {
			...
			$obj->broadcastquota_id = strtoupper($obj->broadcastquota_id);
			$obj->broadcastquota_name = strtoupper($obj->broadcastquota_name);
