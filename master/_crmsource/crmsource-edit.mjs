...
const obj = {
	txt_crmsource_id: $('#pnl_edit-txt_crmsource_id'),
	txt_crmsource_name: $('#pnl_edit-txt_crmsource_name'),
	txt_crmsource_descr: $('#pnl_edit-txt_crmsource_descr')
}
...
export async function init(opt) {
	...
	form = new global.fgta4form(pnl_form, {
		primary: obj.txt_crmsource_id,
		autoid: false,
		logview: 'mst_crmsource',
		btn_edit: btn_edit,
		btn_save: btn_save,
...
function form_idsetup(options) {
	var objid = obj.txt_crmsource_id
