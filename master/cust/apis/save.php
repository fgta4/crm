...
$API = new class extends custBase {
	...
	public function execute($data, $options) {
		...
		try {
			...
			if ($obj->cust_mainphonenumber=='') { $obj->cust_mainphonenumber = '--NULL--'; }
			if ($obj->cust_mainemail=='') { $obj->cust_mainemail = '--NULL--'; }
			if ($obj->cust_birthplace=='') { $obj->cust_birthplace = '--NULL--'; }
