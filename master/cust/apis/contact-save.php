...
/**
 * crm/master/cust/apis/contact-save.php
 *
 * ==========
 * Detil-Save
 * ==========
...
$API = new class extends custBase {
	...
	public function execute($data, $options) {
		...
		try {
			...
			$obj->custcontact_id = strtoupper($obj->custcontact_id);
			$obj->custcontact_data = strtoupper($obj->custcontact_data);
			...
			try {
				...
				$sql = \FGTA4\utils\SqlUtility::Select($tablename , [
					$primarykey
					, 'custcontact_id', 'custcontact_data', 'custcontact_isemail', 'custcontact_isphone', 'custcontact_iswhatsapp', 'cust_id', '_createby', '_createdate', '_modifyby', '_modifydate', '_createby', '_createdate', '_modifyby', '_modifydate'
				], $where->sql);
