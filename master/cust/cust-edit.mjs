...
const obj = {
	txt_cust_id: $('#pnl_edit-txt_cust_id'),
	txt_cust_name: $('#pnl_edit-txt_cust_name'),
	txt_cust_mainphonenumber: $('#pnl_edit-txt_cust_mainphonenumber'),
	txt_cust_mainemail: $('#pnl_edit-txt_cust_mainemail'),
	chk_cust_isdisabled: $('#pnl_edit-chk_cust_isdisabled'),
	txt_cust_birthplace: $('#pnl_edit-txt_cust_birthplace'),
	...
	txt_cust_reasonrejectoffer: $('#pnl_edit-txt_cust_reasonrejectoffer')
}
...
export async function init(opt) {
	...
	obj.chk_cust_ishasbirthinfo.checkbox({onChange: (checked) => { 
		if (typeof hnd.cust_ishasbirthinfo_changed==='function') {hnd.cust_ishasbirthinfo_changed(checked)} 
	}});
...
export function createnew() {
	form.createnew(async (data, options)=>{
		...
		data.cust_isdisabled = '0'
		data.cust_ishasbirthinfo = '0'
		...
		$ui.getPages().ITEMS['pnl_editaddressgrid'].handler.createnew(data, options)
