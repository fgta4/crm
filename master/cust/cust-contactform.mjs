...
import * as hnd from  './cust-contactform-hnd.mjs'
...
const obj = {
	txt_custcontact_id: $('#pnl_editcontactform-txt_custcontact_id'),
	txt_custcontact_data: $('#pnl_editcontactform-txt_custcontact_data'),
	chk_custcontact_isemail: $('#pnl_editcontactform-chk_custcontact_isemail'),
	chk_custcontact_isphone: $('#pnl_editcontactform-chk_custcontact_isphone'),
	chk_custcontact_iswhatsapp: $('#pnl_editcontactform-chk_custcontact_iswhatsapp'),
	txt_cust_id: $('#pnl_editcontactform-txt_cust_id')
}
...
export async function init(opt) {
	...
	form = new global.fgta4form(pnl_form, {
		primary: obj.txt_custcontact_id,
		autoid: true,
		logview: 'mst_custcontact',
		btn_edit: btn_edit,
		btn_save: btn_save,
...
function form_idsetup(options) {
	var objid = obj.txt_custcontact_id
